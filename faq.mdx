<AccordionItem summary="Is OpenTF going to be a foundation?">
...
<AccordionItem summary="Can anyone pledge?">
...
<AccordionItem summary="Doesn't forking hurt the whole community? Why take such a brash action?">
