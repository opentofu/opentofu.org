...
The best way to show practical support for the OpenTofu initiative is to contribute. We recommend you start by [opening an issue](https://github.com/opentffoundation/opentf/blob/main/CONTRIBUTING.md) for bug reports, broken compatibility reports, feature requests, old issue reposts, and quality RFCs.
...
This [contribution guide](https://github.com/opentffoundation/opentf/blob/main/CONTRIBUTING.md) explains OpenTF contribution recommended practices, including how to submit issues, how to get involved in the discussion, how to work on the code, and how to contribute code changes.
...
- Sign the manifesto and pledge your time to help develop this project. This can be done [here](https://github.com/opentffoundation/manifesto), by forking the repository, adding your pledge at the end of the table, and creating a pull request.
