...
In parallel, the OpenTofu core team started working with the community on [a possible port of the Visual Studi Code extension for OpenTofu](https://github.com/opentofu/vscode-opentofu).
