...
If you want to test provider-defined functions, you can use the [corefunc](https://github.com/northwood-labs/terraform-provider-corefunc) provider by Ryan Parman:
