...
const config: Config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: "opentofu-ga",
      content:
        '<a href="/blog/help-us-test-opentofu-1-10-0-beta1/" class="announcement-bar-link"><div class="announcement-bar-content">🚀 OpenTofu 1.10.0 Beta1 is landing! <span class="announcement-arrow">→</span></div></a>',
